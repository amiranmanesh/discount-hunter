...
import { hasToken, looksLikeProductCode, matchScore, normalize, tokenize } from '../src/core/text';

const score = (title: string, query: string) =>
  matchScore(title, tokenize(query), normalize(query));
